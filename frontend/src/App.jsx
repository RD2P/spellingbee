...
function App() {
  ...
  const check = () => {
    if (spell.value == currentWord) console.log("Correct")
      ...
      <div className='max-w-7xl mx-auto mt-12 relative'>
        ...
        <div className="bg-orange-300 py-16 rounded-2xl relative">
          ...
          <div className="flex flex-col items-center gap-5">
            ...
            <button onClick={grabAudio} className='p-6 bg-red-500 cursor-pointer'>Get new</button>


            <div className='flex'>
              <input className='p-4 w-96 text-3xl' type="text" id="input" placeholder="Spell the word" />
            ...
            <div className='flex rounded-lg justify-center p-12 bg-blue-400'>
              ...
              <div className='p-14 text-left text-lg flex flex-col justify-between'>
                <div className='font-thin text-3xl text-white '>
                  <p className='my-4 option' onClick={() => audio.play()}>Can you please repeat the word?</p>
                  <p className='my-4  option'>May I have the definition?</p>
                  <p className='my-4  option'>May I please have the part of speech?</p>
                </div>
                <div>
                  <button className='bg-orange-400 py-3 px-6 text-white font-semibold hover:opacity-95' onClick={() => spell.focus()}>SPELL</button>
                </div>
              </div>
            </div>
